    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ParcelDeliveryTrackingDBEntities>
    {
        ...
        protected override void Seed(ParcelDeliveryTrackingDBEntities context)
        {
            ...
            context.personnel.AddOrUpdate(pl => pl.PersonnelId,
                    new Personnel() { PersonnelId = 1, FirstName = "David", LastName = "Johnson", PhoneNumber = "555-111-2222", EmailAddress = "david@example.com", UserName = "David.Johnson", Availability = "On Duty" },
                    ...
                    new Personnel() { PersonnelId = 4, FirstName = "Linda", LastName = "Willams", PhoneNumber = "555-777-8888", EmailAddress = "linda@example.com", UserName = "LindaW", Availability = "On Duty" },
                    ...
                    new Personnel() { PersonnelId = 6, FirstName = "Laura", LastName = "Anderson", PhoneNumber = "555-222-3333", EmailAddress = "laura@example.com", UserName = "LauraA", Availability = "Off Duty" }
            );
            ...
            context.parcels.AddOrUpdate(p => p.ParcelId,
                    ...
                    new Parcel() { ParcelId = 3, SenderID = 5, ReceiverID = 6, Weight = 3.10, ParcelStatus = "On Hold", AdditionalNotes = "Customer requested delay" },
